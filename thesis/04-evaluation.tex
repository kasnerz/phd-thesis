...
% Our metric remains one of the major options for evaluating the semantic accuracy of data-to-text generation, especially with \ac{rdf} triples on the input. 
