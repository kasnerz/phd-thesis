...
The thesis, we will aim to reconcile the gap: taking neural-based approaches for \ac{d2t} generation able to generate fluent texts across domains, and turning them into reliable and accurate systems. The thesis pivots around neural models which offer new opportunities in making \ac{d2t} generation
