...
\definecolor{errblue}{HTML}{C9404F}
...
\newcommand{\errnum}[1]{{\leavevmode\color{errred} \ul{\textbf{#1\textsuperscript{N}}}}}
\newcommand{\errent}[1]{{\leavevmode\color{errblue} \ul{\textbf{#1\textsuperscript{E}}}}}
\newcommand{\errword}[1]{{\leavevmode\color{errorange} \ul{\textbf{#1\textsuperscript{W}}}}}
\newcommand{\errctx}[1]{{\leavevmode\color{erryellow} \ul{\textbf{#1\textsuperscript{C}}}}}
\newcommand{\errnc}[1]{{\leavevmode\color{errpurple} \ul{\textbf{#1\textsuperscript{NC}}}}}
\newcommand{\errother}[1]{{\leavevmode\color{errgrey} \ul{\textbf{#1\textsuperscript{O}}}}}
