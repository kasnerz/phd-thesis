...
{
  What a ride this has been. When I signed up for the Natural Language Processing course at KU Leuven back in 2017, little did I know it would be the flap of a butterfly wing. Sure, it got overshadowed by many great memories from my Erasmus stay there, but it still sparked my interest. It now feels tempting to say that the spark was fed by my fondness of reading, writing, and learning languages, but that is just hindsight bias---I am pretty sure that if it were not for a couple of other life episodes, I might end up doing something completely different.
  ...
  One such episode brought me from my alma mater to the Institute of Formal and Applied Linguistics. There, I got in touch with Jindřich Helcl and Jindřich Libovický, my current colleagues. Thanks to your course I learned a couple of things: how research feels like, how strong is the link between \acs{ai} and \acs{nlp}, and most importantly, how friendly are the people at the institute. I could not help it, interacting with you just felt natural. After Jindřich H. became my external Master's thesis supervisor, I seriously started to consider doing a PhD here.

  I once heard that the supervisor/student relationship is akin to marriage, at least in the sense that it leads to intense personal interactions over several years. If that is the case, what are the chances that you find a perfect person for such an endeavor during a random encounter in the hallway? However, that is essentially what happened to me. Sincerely, I could not have wished for a better advisor than Ondřej Dušek. Thank you for teaching me how to think and write properly, for all those discussions during our meetings about the quirks of doing research (which were often off-topic but always insightful and fun), for those intense exchanges before paper deadlines which made me feel supported and motivated, and in general for always being there for me, from the very beginning all the way to the write-up of this thesis. Without you, I would not be where I am now.

  Looking back at my five years at ÚFAL, my instincts were correct -- all of you became not only my colleagues, but my friends. I was always inspired by your approach to research: that your primary drive is the inner motivation to do the interesting things instead of chasing fame or research throughput, but still doing it properly so that the research can be considered top-notch. You also inspired me way beyond research. I knew I am in the right place already after our first autumn retreat where we first cycled eighty kilometers, climbed to the peak of Sněžka, and then played guitar the whole evening. To name just a few out of many: thank you, Vojta Hudeček for becoming my friend and outdoor adventure buddy, Rudolf Rosa for inviting me to your wedding, Tomáš Musil for our co-teaching and train rides, people from our NG-NLG team (Simone Balloccu, Mateusz Lango, Sourabrata Mukherjee, Ondřej Plátek, Patrícia Schmidtová) for our lively discussions full of jokes and supportive environment, Tomasz Limisiewicz for our meetings in the hallways and conferences, Tea Vojtěchová for taking part in my ventures to Irish dancing, and all those people that made our monthly ``community activity outside the workplace'' a pleasant experience.

  After two years of covid, my three months at Heriot-Watt University in Edinburgh felt miraculous. Thank you, Ioannis Konstas, for being my mentor and Xinnuo Xu for being my friend during these times. Another dream of mine which became true was my internship at the Mila research institute in Montréal. I am truly grateful to Siva Reddy and the rest of the team for accepting me to your group. Special thanks go to Xing Han Lù for your enthusiasm, cool ideas, and being my friend in Montréal and abroad. Our pair programming was an enriching experience, especially with your thoughtful process of making coffee.

  None of this would count if I would not be able to enjoy my life outside of research. Luckily, I was blessed to have many friends which made these five years a real joyride. Thanks to the X-Challenge community for teaching me how to live, Vlakfest and Expedition Club for taking me to unorthodox adventures, and people from the Board of European Students of Technology for staying in my life way beyond our university years. And thanks to other people that I did not get a chance to mention but your name belongs here.

  The list would not be complete without you, Lenka. You became such an important element in my life that I cannot imagine it without you. Thank you for all the support that I got during writing this thesis, those times spent together, those internal jokes, those moments of understanding, and those common horizons I am looking forward to. You give sense to all of this.

  I am turning thirty at the time I am submitting this thesis. All those thirty years, I have been constantly supported from my family. Thanks to my parents, Zdeněk and Dana, for providing me unconditional refuge and for tirelessly caring about my life. Thanks to my brother Marek for our discussions, friendship, and many adventures. Lastly, thanks to my grandmother Zdeňka, who---besides raising me as a kid---supported my vague childhood idea of becoming me a university teacher ``since I will have three months of holidays''. I am sure that she would be proud nevertheless.


  \vspace{1\baselineskip}
  \noindent If you are the village, I am the child. Who knows, which of you made me enjoy writing so much that I barely know when to stop\ldots
