...
\begin{itemize}
    ...
    \item \textbf{NIST} \cite{martin2000nist} is a metric which focuses on precision similarly to BLEU. It assigns lower weights to less common n-grams, which are considered less informative.
