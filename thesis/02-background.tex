...
% The term \emph{data-driven} encompasses approaches built on statistics or classical machine learning methods for building the models on large text corpora\footnote{Again, please note that data-driven approaches are not mutually exclusive with }.
