...
\paragraph{Data Linearization} To get an input sequence suitable for the neural model, the structured data needs to be linearized as a sequence of tokens. To preserve the original structure of data, a common practice is to use special tokens serving as delimiters, as depicted in \TODO{figure} \cite{yang2020improving,hoyle2021promoting,xieUnifiedSKGUnifyingMultiTasking2022}. Alternatively, special embeddings can be used which are summed with the positional and token embeddings \cite{wang2021tuta,yangTableFormerRobustTransformer2022}.
